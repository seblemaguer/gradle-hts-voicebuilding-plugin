...
class MaryTTS {
    ...
    def static export(project) {        
         ...
         *******************************************************************************************/
        def user_configuration = project.gradle.vb_configuration
         ...
         *******************************************************************************************/
        (new File("$export_dir/config.json")).text = new JsonBuilder(project.gradle.vb_configuration).toPrettyString()
